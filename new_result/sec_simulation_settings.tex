...
compatible receivers in decreasing order of the validation quality
reported by the encoder's publisher, thereby favoring encoders
trained on larger, higher-quality local datasets, without considering
receiver demand.
