...
(5)~\textbf{AutoFed}~\cite{autofed}: encoders are offered to
compatible receivers in order of the publisher's encoder quality, so
clean, data-rich sources are disseminated first as in AutoFed,
without considering receiver demand.
