...
(1)~\textbf{Caching}: store--carry--forward relaying that replicates
encoders opportunistically without demand awareness, in the spirit of
spray-and-wait~\cite{spyropoulos2005spray};
